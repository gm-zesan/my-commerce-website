                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-images">
                            <main id="gallery">
                                <div class="main-img">
                                    <img src="{{ asset('/website') }}/assets/images/product-details/01.jpg" id="current"
                                        alt="#">
                                </div>
                                <div class="images">
                                    <img src="{{ asset('/website') }}/assets/images/product-details/01.jpg" class="img"
                                        alt="#">
                                    <img src="{{ asset('/website') }}/assets/images/product-details/02.jpg" class="img"
                                        alt="#">
                                    <img src="{{ asset('/website') }}/assets/images/product-details/03.jpg" class="img"
                                        alt="#">
                                    <img src="{{ asset('/website') }}/assets/images/product-details/04.jpg" class="img"
                                        alt="#">
                                    <img src="{{ asset('/website') }}/assets/images/product-details/05.jpg" class="img"
                                        alt="#">
                                </div>
                            </main>
                        </div>
                                ...
                                <div class="row align-items-end">
                                    <div class="col-lg-4 col-md-4 col-12">
                                        <div class="button cart-button">
                                            <a href="{{ route('show-cart') }}" class="btn pt-2" style="width: 100%;">Add to
                                                Cart</a>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-12">
